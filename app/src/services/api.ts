...
export const passkeyAPI = {
  ...
  verifyRegister: (credential: any) =>
    api.post("/passkeys/register/verify", credential),
  getAuthOptions: (email: string) =>
    api.post("/passkeys/auth/options", { email }),
  verifyAuth: (credential: any) =>
    api.post("/passkeys/auth/verify", credential),
...
export const userAPI = {
  ...
  updateProfile: (name: string, bio?: string) =>
    api.patch("/users/profile", { name, bio }),
  ...
  generateAvatar: (prompt?: string) =>
    api.post("/users/avatar/generate", { prompt }),
  ...
  acceptFriendRequest: (requestId: string) =>
    api.post(`/users/friends/requests/${requestId}/accept`),
  declineFriendRequest: (requestId: string) =>
    api.post(`/users/friends/requests/${requestId}/decline`),
...
export const callAPI = {
  getHistory: (cursor?: string) =>
    api.get("/calls/history", { params: { cursor } }),
};
...
export const pollAPI = {
  ...
  getPollByMessageId: (messageId: string) =>
    api.get(`/polls/by-message/${messageId}`),
};
